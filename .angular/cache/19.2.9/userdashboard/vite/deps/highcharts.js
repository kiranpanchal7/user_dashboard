...
var require_highcharts = __commonJS({
 ...
 - ${i11}: ${e11}`, r10 && (a10 += encodeURI(i11) + "=" + encodeURI(e11));
      ...
      let tU = {
        animate: function(t10, e10, i10) {
          ...
          tH(i10) || (n10 = arguments, i10 = {
            ...
            easing: n10[3],
            complete: n10[4]
          }), tW(i10.duration) || (i10.duration = 400), i10.easing = "function" == typeof i10.easing ? i10.easing : Math[i10.easing] || Math.easeInOutSine, i10.curAnim = tF(e10), tX(e10, function(n11, h10) {
      ...
      function ed(t10 = "", e10, i10) {
        let s10 = /\{([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/g, o10 = /\(([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'= ]+)\)/g, r10 = [], a10 = /f$/, n10 = /\.(\d)/, h10 = i10?.options?.lang || t9.lang, l2 = i10?.time || t4, d2 = i10?.numberFormatter || ec, c2 = (t11 = "") => {
          let i11;
      ...
      class eK {
        ...
        shadow(t10) {
          let {
            ...
            offsetX: -1,
            offsetY: -1
          } : {}, eX(t10) ? t10 : {}), s10 = e10.shadowDefinition(i10);
          return this.attr({
      ...
      class iU {
        ...
        symbol(t10, e10, i10, s10, o10, r10) {
          ...
          if (u2) "number" == typeof e10 && (n10 = u2.call(this.symbols, e10 || 0, i10 || 0, s10 || 0, o10 || 0, r10)), a10 = this.path(n10), d2.styledMode || a10.attr("fill", "none"), iN(a10, {
            ...
            s11.imgwidth = iX(r10?.width, iC[h10]?.width), s11.imgheight = iX(r10?.height, iC[h10]?.height), l2 = (t11) => t11.attr({
              width: t11.width,
              height: t11.height
        ...
        updateTransform() {
          ...
          if (e10 || i_(t10, {
            ...
            if (p2 !== i10) {
              ...
              (s11 > i10 || e11 > s11 || r11) && (/[\-\s\u00AD]/.test(t10.textContent || t10.innerText) || "ellipsis" === t10.style.textOverflow) && (i_(t10, {
                width: (o10 || n10 || e11 > s11 || r11) && i0(p2) ? p2 + "px" : "auto",
                display: l2,
      ...
      let si = a, {
        ...
        splat: sj,
        syncTimeout: sY
      } = V, sU = (t10, e10) => sW(e10, void 0, void 0, sF(t10.options.allowDecimals, e10 < 0.5 || void 0 !== t10.tickAmount), !!t10.tickAmount);
      sO(sb, {
        xAxis: sx,
        yAxis: sR(sx, sy)
      });
      class s$ {
        ...
        init(t10, e10, i10 = this.coll) {
          ...
          this.chart = t10, this.horiz = o10, this.isXAxis = s10, this.coll = i10, sE(this, "init", {
            userOptions: e10
          }), this.opposite = sF(e10.opposite, this.opposite), this.side = sF(e10.side, this.side, o10 ? 2 * !this.opposite : this.opposite ? 1 : 3), this.setOptions(e10);
        ...
        adjustTickAmount() {
          ...
          } = t10, h10 = r10?.length, l2 = sF(t10.threshold, t10.softThreshold ? 0 : null), d2, c2, p2 = t10.tickInterval, g2, u2 = () => r10.push(sT(r10[r10.length - 1] + p2)), f2 = () => r10.unshift(sT(r10[0] - p2));
        ...
        autoLabelAlign(t10) {
          let e10 = (sF(t10, 0) - 90 * this.side + 720) % 360, i10 = {
            align: "center"
          };
        ...
        getOffset() {
          ...
          if (t10.showAxis = m2 = l2 || s10.showEmpty, t10.staggerLines = t10.horiz && c2.staggerLines || void 0, t10.createGroups(), l2 || t10.isLinked ? (a10.forEach(function(e11) {
            ...
            1: "left",
            3: "right"
          }[o10] === t10.labelAlign, sF(c2.reserveSpace, !p2 && null, "center" === t10.labelAlign || null, t10.reserveSpaceDefault) && a10.forEach(function(t11) {
          ...
          }), d2?.text && false !== d2.enabled && (t10.addTitle(m2), m2 && !p2 && false !== d2.reserveSpace && (t10.titleOffset = x2 = t10.axisTitle.getBBox()[i10 ? "height" : "width"], b2 = sC(y2 = d2.offset) ? 0 : sF(d2.margin, i10 ? 5 : 10))), t10.renderLine(), t10.offset = f2 * sF(s10.offset, g2[o10] ? g2[o10] + (s10.margin || 0) : 0), t10.tickRotCorr = t10.tickRotCorr || {
            x: 0,
            y: 0
          }, w2 = 0 === o10 ? -t10.labelMetrics().h : 2 === o10 ? t10.tickRotCorr.y : 0, k2 = Math.abs(v2) + b2, v2 && (k2 -= w2, k2 += f2 * (i10 ? sF(c2.y, t10.tickRotCorr.y + f2 * c2.distance) : sF(c2.x, f2 * c2.distance))), t10.axisTitleMargin = sF(y2, k2), t10.getMaxLabelDimensions && (t10.maxLabelDimensions = t10.getMaxLabelDimensions(r10, a10)), "colorAxis" !== n10 && u2) {
        ...
        drawCrosshair(t10, e10) {
          ...
          if (sE(this, "drawCrosshair", {
            ...
            if (s10 ? sC(e10) && (a10 = sF("colorAxis" !== this.coll ? e10.crosshairPos : null, this.isXAxis ? e10.plotX : this.len - e10.plotY)) : a10 = t10 && (this.horiz ? t10.chartX - this.pos : this.len - t10.chartY + this.pos), sC(a10) && (l2 = {
              value: e10 && (this.isXAxis ? e10.x : sF(e10.stackY, e10.y)),
              translatedValue: a10
            }, o10.polar && sO(l2, {
              isCrosshair: true,
              chartX: t10?.chartX,
              chartY: t10?.chartY,
              point: e10
            }), r10 = this.getPlotLinePath(l2) || null), !sC(r10)) {
              this.hideCrosshair();
              return;
            }
      ...
      class r0 {
        ...
        update(t10, e10) {
          ...
          g2 = g2 || r10, u2 ? (p2.push.apply(p2, r0.keepPropsForPoints), false !== t10.visible && p2.push("area", "graph"), i10.parallelArrays.forEach(function(t11) {
            p2.push(t11 + "Data");
          }), t10.data && (t10.dataSorting && rF(i10.options.dataSorting, t10.dataSorting), this.setData(t10.data, false))) : this.dataTable.modified = this.dataTable, t10 = r_(o10, {
      ...
      class a0 {
        ...
        temporaryDisplay(t10) {
          ...
          else for (; e10?.style && (aw.body.contains(e10) || e10.parentNode || (e10.hcOrigDetached = true, aw.body.appendChild(e10)), ("none" === aF(e10, "display", false) || e10.hcOricDetached) && (e10.hcOrigStyle = {
        ...
        reflow(t10) {
          ...
          delete e10.pointer?.chartPosition, !e10.isPrinting && !e10.isResizing && i10 && s10.width && ((s10.width !== i10.width || s10.height !== i10.height) && (V.clearTimeout(e10.reflowTimeout), e10.reflowTimeout = aJ(function() {
          ...
          for (let t11 of (this.hoverPoints?.forEach((t12) => t12.setState()), e10)) {
            ...
            if (T2 > C2 && ([T2, C2] = [C2, T2]), 1 === k2 && !o10 && "yAxis" === t11.coll && !A2) {
              for (let e12 of t11.series) {
                ...
                }), aG(t12.dataMin) && aG(t12.dataMax) && (A2.dataMin = Math.min(t12.dataMin, A2.dataMin), A2.dataMax = Math.max(t12.dataMax, A2.dataMax));
              }
              t11.allExtremes = A2;
            }
            let {
              ...
              min: O2,
              max: E2
            } = az(t11.getExtremes(), A2 || {}), I2 = l2.parse(f2.min), D2 = l2.parse(f2.max), B2 = P2 ?? I2, N2 = L2 ?? D2, z2 = C2 - T2, R2 = t11.categories ? 0 : Math.min(z2, N2 - B2), W2 = B2 - R2 * (aE(I2) ? 0 : f2.minPadding), H2 = N2 + R2 * (aE(D2) ? 0 : f2.maxPadding), F2 = t11.allowZoomOutside || 1 === k2 || "zoom" !== n10 && k2 > 1, X2 = Math.min(I2 ?? W2, W2, F2 ? O2 : W2), G2 = Math.max(D2 ?? H2, H2, F2 ? E2 : H2);
            (!t11.isOrdinal || t11.options.overscroll || 1 !== k2 || o10) && (T2 < X2 && (T2 = X2, k2 >= 1 && (C2 = T2 + z2)), C2 > G2 && (C2 = G2, k2 >= 1 && (T2 = C2 - z2)), (o10 || t11.series.length && (T2 !== O2 || C2 !== E2) && T2 >= X2 && C2 <= G2) && (r10 ? r10[t11.coll].push({
              axis: t11,
              min: T2,
              max: C2
              ...
              trigger: n10,
              scale: k2
            }), !o10 && (T2 > X2 || C2 < G2) && "mousewheel" !== n10 && (c2 = true)), d2 = true), i10 && (this[e11 ? "mouseDownX" : "mouseDownY"] = i10[e11 ? "chartX" : "chartY"]));
          }
              ...
              (i12.dataLabels || []).forEach((l3) => {
                ...
                if (x3) {
                  ...
                  if (x3.attribs = {
                    ...
                    y: M2 + (d4.y || 0) - v3 / 2
                  }, x3.computed.x = w2, x3.computed.y = M2 - k2, h6(d4.crop, true)) {
                    let t12;
        ...
        for (let i11 = 0; i11 < e10; i11++) (o10 = t10[i11]) && (o10.oldOpacity = o10.opacity, o10.newOpacity = 1, o10.absoluteBox = function(t11) {
          if (t11 && (!t11.alignAttr || t11.placed)) {
            let e11 = t11.box ? 0 : t11.padding || 0, i12 = t11.alignAttr || {
              ...
              polygon: o11,
              width: r11
            } = t11.getBBox(), a11 = le(t11.alignValue) * r11;
      ...
      function la(t10, e10) {
        ...
        }), li(e10, "afterHideOverlappingLabel")) : t10.attr({
          opacity: i10
        })), t10.isOld = true), s10;
      }
      function ln() {
      ...
      function lv() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          let {
            options: t10,
            yAxis: e10
          } = this, i10 = "percent" === t10.stacking, s10 = ll.plotOptions?.[this.type]?.borderRadius, o10 = lk(t10.borderRadius, lg(s10) ? s10 : {}), r10 = e10.options.reversed;
      ...
      !function(t10) {
        ...
        function i10(t11, e11) {
          ...
          let n10 = s10?.ruleIds;
          o10 === n10 || (s10 && (this.currentResponsive = void 0, this.updatingResponsive = true, this.update(s10.undoOptions, t11, true), this.updatingResponsive = false), o10 ? ((r10 = lS(a10, this.options, true, this.collectionsWithUpdate)).isResponsiveOptions = true, this.currentResponsive = {
            ruleIds: o10,
            mergedOptions: a10,
            undoOptions: r10
        ...
        t10.compose = function(t11) {
          ...
          return s10.matchResponsiveRule || lT(s10, {
      ...
      w.AST = t6, w.Axis = s$, w.Chart = a0, w.Color = tL, w.DataLabel = hf, w.DataTableCore = rp, w.Fx = tB, w.HTMLElement = i6, w.Legend = au, w.LegendSymbol = rm, w.OverlappingDataLabels = w.OverlappingDataLabels || lh, w.PlotLineOrBand = oa, w.Point = oK, w.Pointer = ra, w.RendererRegistry = eg, w.Series = r1, w.SeriesRegistry = rk, w.StackItem = nd, w.SVGElement = eJ, w.SVGRenderer = iU, w.Templating = ep, w.Tick = sf, w.Time = tu, w.Tooltip = oE, w.animate = tU.animate, w.animObject = tU.animObject, w.chart = a0.chart, w.color = tL.parse, w.dateFormat = ep.dateFormat, w.defaultOptions = tv.defaultOptions, w.distribute = ey.distribute, w.format = ep.format, w.getDeferredAnimation = tU.getDeferredAnimation, w.getOptions = tv.getOptions, w.numberFormat = ep.numberFormat, w.seriesType = rk.seriesType, w.setAnimation = tU.setAnimation, w.setOptions = tv.setOptions, w.stop = tU.stop, w.time = tv.defaultTime, w.timers = tB.timers, {
        compose: function(t10, e10, i10) {
          ...
          if (!e10.symbolCustomAttribs.includes("borderRadius")) {
            ...
            lc(t10, "afterColumnTranslate", lv, {
              order: 9
            }), lc(s10, "afterTranslate", lw), e10.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY"), lx = o10.arc, ly = o10.roundedRect, o10.arc = lb, o10.roundedRect = lM;
          }
        },
        optionsToObject: lk
